...
export function Header () {
  ...
  // }
    ...
    return (
        ...
        {/* {isModalOpen ? 'oi' : null }          Se o modal estiver aberto (?) oi se não (:) nulp */}

        <Dialog.Root>
          <Dialog.Trigger 
          type='button'
          className="border border-violet-500 font-semibold rounded-lg px-6 py-4 flex items-center gap-3 hover:border-violet-300 m-20">
